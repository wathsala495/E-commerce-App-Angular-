...
export class UserCrudComponent implements OnInit {
  ...
  editUserPopup(user_id:any){
    ...
    this.adminService.singleUser(user_id).subscribe((data)=>{
      ...
      console.log("single user:"+JSON.stringify(this.single_user_data))
      this.upload_file_name=this.single_user_data.uploadPhoto;
      console.log("email:"+this.single_user_data.email )
      console.log("addressline1:"+this.single_user_data.address.addLine1 )
      ...
      console.log("setvalue:"+JSON.stringify(this.addEditUserForm.value))
...
//     this.add_user = false;
//     this.popup_header = "Edit User";
//     this.adminService.singleuUser(user_id).subscribe((data:any)=>{
